        ...
        <div className='form-control '>
          <div className="row mx-2">
            <div className="col-sm-6">
              ...
              <input placeholder="Enter field" value={data.jobTitles} type="text" className="form-control" id="formGroupExampleInput" name="jobTitles" onChange={inputChangeHandler} />
            </div>
          </div>
