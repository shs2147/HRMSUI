...
const FixingInterviewOnline = () => {
 ...
 console.log("Intrview scheduled")
    ...
    <div className="col-sm-6 mt-2">
           <label for="cars" id='label'>Candidate:</label>
         <br/>  
     <select valueType={data.candidate}class="form-select" aria-label="Default select example"name="candidate" onChange={inputChangeHandler}>
      <option selected disabled>Select Vacancy First</option>
      <option valueType="aman">Aman</option>
      <option valueType="amit">Amit</option>
      <option valueType="ranjan">Ranjan</option>
      <option valueType="saurav">Saurav</option>
